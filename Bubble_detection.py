...
class Bubble:
    def __init__(self, k, threshold, read_data):
        self.k = k
    ...
    @staticmethod
    def de_bruijn(k_mers, k_min_1_mers):
        to_id = dict()
    ...
    def num_bubbles(self):
        ...
        n = len(k_min_1_mers)
        edges = self.de_bruijn(k_mers, k_min_1_mers)
