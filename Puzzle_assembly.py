...
class Puzzle:
    def __init__(self, sq):
        ...
        self._color_to_id, self._id_to_color = self._get_color_maps(self.sq)
        self._squares = self._get_inner_squares(self.sq, self._color_to_id)
...
if __name__ == "__main__":
    def sol():
        num_squares = 25
        r = Puzzle.read_input(num_squares)
        res = r.ans()
        r.print_result(res)
    sol()
